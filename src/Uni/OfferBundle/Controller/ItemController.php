...
use Uni\AdminBundle\Entity\Item;
use Uni\OfferBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $items = $em->getRepository('UniAdminBundle:Item')->findBy(array(), array($sort => $direction));
        else $items = $em->getRepository('UniAdminBundle:Item')->findAll();
        ...
        return $this->render('UniOfferBundle:Item:index.html.twig', array(
            'items' => $items,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        if ($newForm->isSubmitted()) {
            if($newForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('offer_item_index'));
            }
        }

        return $this->render('UniOfferBundle:Item:new.html.twig', array(
    ...
    private function createNewForm(Item $item)
    {
        return $this->createForm(new ItemType(), $item, array(
            'action' => $this->generateUrl('offer_item_new'),
        ));
    }
    ...
    public function showAction(Item $item)
    {
        ...
        return $this->render('UniOfferBundle:Item:show.html.twig', array(
            'item' => $item,
    ...
    public function editAction(Request $request, Item $item)
    {
        ...
        return $this->render('UniOfferBundle:Item:edit.html.twig', array(
            'item' => $item,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new ItemType(), $item, array(
            'action' => $this->generateUrl('offer_item_edit', array('id' => $item->getId())),
        ));
    }
    ...
    private function createDeleteForm(Item $item)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('offer_item_delete', array('id' => $item->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
