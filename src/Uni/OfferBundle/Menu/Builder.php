...
class Builder implements ContainerAwareInterface
{
    ...
    public function sideMenu(FactoryInterface $factory, array $options)
    {
        ...
        $sidemenu->addChild('sidemenu.order.root', array('route' => 'offer_order_index'))->setExtras(array('translation_domain' => 'UniOfferBundle', 'routes' => array(
            'offer_order_index',
            'offer_order_new',
            'offer_order_show',
            'offer_order_edit',
        ...
        $sidemenu->addChild('sidemenu.invoice.root', array('route' => 'offer_invoice_index'))->setExtras(array('translation_domain' => 'UniOfferBundle', 'routes' => array(
            ...
            'offer_invoice_show',
            'offer_invoice_edit',
            'offer_shipment_index',
            'offer_shipment_new',
            'offer_shipment_show',
            'offer_shipment_edit',
            'offer_invoiceaction_index',
            'offer_invoiceaction_new',
            'offer_invoiceaction_show',
            'offer_invoiceaction_edit',
        )));
/*
        $sidemenu->addChild('sidemenu.shipment.root', array('route' => 'offer_shipment_index'))->setExtras(array('translation_domain' => 'UniOfferBundle', 'routes' => array(
            'offer_shipment_index',
            'offer_shipment_new',
            'offer_shipment_show',
            'offer_shipment_edit',
        )));
        $sidemenu->addChild('sidemenu.invoiceaction.root', array('route' => 'offer_invoiceaction_index'))->setExtras(array('translation_domain' => 'UniOfferBundle', 'routes' => array(
            'offer_invoiceaction_index',
            'offer_invoiceaction_new',
            'offer_invoiceaction_show',
            'offer_invoiceaction_edit',
