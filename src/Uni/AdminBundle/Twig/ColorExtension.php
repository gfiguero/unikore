...
namespace Uni\AdminBundle\Twig;
...
class ColorExtension extends \Twig_Extension {
    ...
    {
        return array(
            new \Twig_SimpleFunction('color_darken', array($this, 'darken')),
            new \Twig_SimpleFunction('color_lighten', array($this, 'lighten')),
            new \Twig_SimpleFunction('color_red', array($this, 'red')),
            new \Twig_SimpleFunction('color_green', array($this, 'green')),
            new \Twig_SimpleFunction('color_blue', array($this, 'blue')),
            new \Twig_SimpleFunction('color_alpha', array($this, 'alpha')),
            new \Twig_SimpleFunction('color_mix', array($this, 'mix')),
        );
    }
