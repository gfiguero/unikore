...
use Uni\AdminBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $clients = $em->getRepository('UniAdminBundle:Client')->findBy(array(), array($sort => $direction));
        else $clients = $em->getRepository('UniAdminBundle:Client')->findAll();
        ...
        return $this->render('UniAdminBundle:Client:index.html.twig', array(
            'clients' => $clients,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Client:new.html.twig', array(
    ...
    private function createNewForm(Client $client)
    {
        return $this->createForm(new ClientType(), $client, array(
            'action' => $this->generateUrl('admin_client_new'),
        ));
    }
    ...
    public function showAction(Client $client)
    {
        ...
        return $this->render('UniAdminBundle:Client:show.html.twig', array(
            'client' => $client,
    ...
    public function editAction(Request $request, Client $client)
    {
        ...
        return $this->render('UniAdminBundle:Client:edit.html.twig', array(
            'client' => $client,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new ClientType(), $client, array(
            'action' => $this->generateUrl('admin_client_edit', array('id' => $client->getId())),
        ));
    }
