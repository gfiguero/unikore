...
use Uni\AdminBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Item:index.html.twig', array(
            'items' => $items,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Item:new.html.twig', array(
    ...
    private function createNewForm(Item $item)
    {
        return $this->createForm(new ItemType(), $item, array(
            'action' => $this->generateUrl('admin_item_new'),
        ));
    }
    ...
    public function showAction(Item $item)
    {
        ...
        return $this->render('UniAdminBundle:Item:show.html.twig', array(
            'item' => $item,
    ...
    public function editAction(Request $request, Item $item)
    {
        ...
        return $this->render('UniAdminBundle:Item:edit.html.twig', array(
            'item' => $item,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new ItemType(), $item, array(
            'action' => $this->generateUrl('admin_item_edit', array('id' => $item->getId())),
        ));
    }
