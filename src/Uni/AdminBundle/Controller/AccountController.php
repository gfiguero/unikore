...
use Uni\AdminBundle\Form\AccountType;
...
class AccountController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Account:index.html.twig', array(
            'accounts' => $accounts,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Account:new.html.twig', array(
    ...
    public function showAction(Account $account)
    {
        ...
        return $this->render('UniAdminBundle:Account:show.html.twig', array(
            'account' => $account,
    ...
    public function editAction(Request $request, Account $account)
    {
        ...
        return $this->render('UniAdminBundle:Account:edit.html.twig', array(
            'account' => $account,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
