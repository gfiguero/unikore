...
use Uni\AdminBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Group:index.html.twig', array(
            'groups' => $groups,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Group:new.html.twig', array(
    ...
    public function showAction(Group $group)
    {
        ...
        return $this->render('UniAdminBundle:Group:show.html.twig', array(
            'group' => $group,
    ...
    public function editAction(Request $request, Group $group)
    {
        ...
        return $this->render('UniAdminBundle:Group:edit.html.twig', array(
            'group' => $group,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
