...
use Uni\AdminBundle\Form\IssuerType;
...
class IssuerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $issuers = $em->getRepository('UniAdminBundle:Issuer')->findBy(array(), array($sort => $direction));
        else $issuers = $em->getRepository('UniAdminBundle:Issuer')->findAll();
        ...
        return $this->render('UniAdminBundle:Issuer:index.html.twig', array(
            'issuers' => $issuers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Issuer:new.html.twig', array(
    ...
    public function showAction(Issuer $issuer)
    {
        ...
        return $this->render('UniAdminBundle:Issuer:show.html.twig', array(
            'issuer' => $issuer,
    ...
    public function editAction(Request $request, Issuer $issuer)
    {
        ...
        return $this->render('UniAdminBundle:Issuer:edit.html.twig', array(
            'issuer' => $issuer,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
