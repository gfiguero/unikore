...
use Uni\AdminBundle\Entity\Commune;
use Uni\AdminBundle\Form\CommuneType;
...
class CommuneController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $communes = $em->getRepository('UniAdminBundle:Commune')->findBy(array(), array($sort => $direction));
        else $communes = $em->getRepository('UniAdminBundle:Commune')->findAll();
        ...
        return $this->render('UniAdminBundle:Commune:index.html.twig', array(
            'communes' => $communes,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Commune:new.html.twig', array(
    ...
    public function showAction(Commune $commune)
    {
        ...
        return $this->render('UniAdminBundle:Commune:show.html.twig', array(
            'commune' => $commune,
    ...
    public function editAction(Request $request, Commune $commune)
    {
        ...
        return $this->render('UniAdminBundle:Commune:edit.html.twig', array(
            'commune' => $commune,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
