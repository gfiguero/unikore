...
use Uni\AdminBundle\Form\ProviderType;
...
class ProviderController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $providers = $em->getRepository('UniAdminBundle:Provider')->findBy(array(), array($sort => $direction));
        else $providers = $em->getRepository('UniAdminBundle:Provider')->findAll();
        ...
        return $this->render('UniAdminBundle:Provider:index.html.twig', array(
            'providers' => $providers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Provider:new.html.twig', array(
    ...
    public function showAction(Provider $provider)
    {
        ...
        return $this->render('UniAdminBundle:Provider:show.html.twig', array(
            'provider' => $provider,
    ...
    public function editAction(Request $request, Provider $provider)
    {
        ...
        return $this->render('UniAdminBundle:Provider:edit.html.twig', array(
            'provider' => $provider,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
