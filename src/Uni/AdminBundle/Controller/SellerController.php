...
use Uni\AdminBundle\Form\SellerType;
...
class SellerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $sellers = $em->getRepository('UniAdminBundle:Seller')->findBy(array(), array($sort => $direction));
        else $sellers = $em->getRepository('UniAdminBundle:Seller')->findAll();
        ...
        return $this->render('UniAdminBundle:Seller:index.html.twig', array(
            'sellers' => $sellers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Seller:new.html.twig', array(
    ...
    public function showAction(Seller $seller)
    {
        ...
        return $this->render('UniAdminBundle:Seller:show.html.twig', array(
            'seller' => $seller,
    ...
    public function editAction(Request $request, Seller $seller)
    {
        ...
        return $this->render('UniAdminBundle:Seller:edit.html.twig', array(
            'seller' => $seller,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
