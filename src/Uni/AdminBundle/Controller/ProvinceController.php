...
use Uni\AdminBundle\Entity\Province;
use Uni\AdminBundle\Form\ProvinceType;
...
class ProvinceController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $provinces = $em->getRepository('UniAdminBundle:Province')->findBy(array(), array($sort => $direction));
        else $provinces = $em->getRepository('UniAdminBundle:Province')->findAll();
        ...
        return $this->render('UniAdminBundle:Province:index.html.twig', array(
            'provinces' => $provinces,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Province:new.html.twig', array(
    ...
    public function showAction(Province $province)
    {
        ...
        return $this->render('UniAdminBundle:Province:show.html.twig', array(
            'province' => $province,
    ...
    public function editAction(Request $request, Province $province)
    {
        ...
        return $this->render('UniAdminBundle:Province:edit.html.twig', array(
            'province' => $province,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
