...
use Uni\AdminBundle\Entity\Region;
use Uni\AdminBundle\Form\RegionType;
...
class RegionController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $regions = $em->getRepository('UniAdminBundle:Region')->findBy(array(), array($sort => $direction));
        else $regions = $em->getRepository('UniAdminBundle:Region')->findAll();
        ...
        return $this->render('UniAdminBundle:Region:index.html.twig', array(
            'regions' => $regions,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Region:new.html.twig', array(
    ...
    public function showAction(Region $region)
    {
        ...
        return $this->render('UniAdminBundle:Region:show.html.twig', array(
            'region' => $region,
    ...
    public function editAction(Request $request, Region $region)
    {
        ...
        return $this->render('UniAdminBundle:Region:edit.html.twig', array(
            'region' => $region,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
