...
use Uni\AdminBundle\Form\CatalogType;
...
class CatalogController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Catalog:index.html.twig', array(
            'catalogs' => $catalogs,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAdminBundle:Catalog:new.html.twig', array(
    ...
    private function createNewForm(Catalog $catalog)
    {
        return $this->createForm(new CatalogType(), $catalog, array(
            'action' => $this->generateUrl('admin_catalog_new'),
        ));
    }
    ...
    public function showAction(Catalog $catalog)
    {
        ...
        return $this->render('UniAdminBundle:Catalog:show.html.twig', array(
            'catalog' => $catalog,
    ...
    public function editAction(Request $request, Catalog $catalog)
    {
        ...
        return $this->render('UniAdminBundle:Catalog:edit.html.twig', array(
            'catalog' => $catalog,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new CatalogType(), $catalog, array(
            'action' => $this->generateUrl('admin_catalog_edit', array('id' => $catalog->getId())),
        ));
    }
    ...
    private function createDeleteForm(Catalog $catalog)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_catalog_delete', array('id' => $catalog->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
