...
class Product
{
    ...
    /**
     * @var \Uni\AdminBundle\Entity\Provider
     */
    private $provider;
    ...
    {
        return round($this->getPrice() / 1.19);
    }
     ...
     * @return Product
     */
    public function setProvider(\Uni\AdminBundle\Entity\Provider $provider = null)
    {
     ...
     * Get provider
     *
     * @return \Uni\AdminBundle\Entity\Provider
     */
     ...
     * @ORM\ManyToOne(targetEntity="Uni\AdminBundle\Entity\Subcategory")
