    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('photographies', 'bootstrap_collection', array(
                'label' => 'page.form.photographies',
                'attr'  => array( 'label_col' => 4, 'widget_col' => 8 ),
                'translation_domain' => 'UniControlPanelBundle',
                'entry_type' => 'Uni\ControlPanelBundle\Form\PhotographyType',
                'allow_add' => true,
                'allow_delete' => true,
                'add_button_text'    => 'page.form.addphotography',
                'delete_button_text' => 'page.form.deletephotography',
                'prototype_name' => 'photographies_collection',
                'delete_empty' => true,
                'by_reference' => false,
                'sub_widget_col' => 11,
                'button_col' => 1,
