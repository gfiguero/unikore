...
class PhotographyController extends Controller
{
    ...
    private function createNewForm(Photography $photography)
    {
        return $this->createForm(new PhotographyType(), $photography, array(
            'action' => $this->generateUrl('controlpanel_photography_new'),
        ));
    }
    ...
    public function showAction(Photography $photography)
    {
        ...
        return $this->render('UniControlPanelBundle:Photography:show.html.twig', array(
    ...
    {
        return $this->createForm(new PhotographyType(), $photography, array(
            'action' => $this->generateUrl('controlpanel_photography_edit', array('id' => $photography->getId())),
        ));
    }
