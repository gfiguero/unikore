...
use Uni\ControlPanelBundle\Form\SocialmediaType;
...
class SocialmediaController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniControlPanelBundle:Socialmedia:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($newForm->isSubmitted()) {
            if($newForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('controlpanel_socialmedia_index'));
            }
        }

        return $this->render('UniControlPanelBundle:Socialmedia:new.html.twig', array(
    ...
    private function createNewForm(Socialmedia $socialmedia)
    {
        return $this->createForm(new SocialmediaType(), $socialmedia, array(
            'action' => $this->generateUrl('controlpanel_socialmedia_new'),
        ));
    }
    ...
    public function showAction(Socialmedia $socialmedia)
    {
        ...
        return $this->render('UniControlPanelBundle:Socialmedia:show.html.twig', array(
    ...
    public function editAction(Request $request, Socialmedia $socialmedia)
    {
        ...
        return $this->render('UniControlPanelBundle:Socialmedia:edit.html.twig', array(
            'socialmedia' => $socialmedia,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new SocialmediaType(), $socialmedia, array(
            'action' => $this->generateUrl('controlpanel_socialmedia_edit', array('id' => $socialmedia->getId())),
        ));
    }
    ...
    private function createDeleteForm(Socialmedia $socialmedia)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('controlpanel_socialmedia_delete', array('id' => $socialmedia->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
