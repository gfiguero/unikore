...
use Uni\ControlPanelBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniControlPanelBundle:User:index.html.twig', array(
            'users' => $users,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        if ($newForm->isSubmitted()) {
            if($newForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('controlpanel_user_index'));
            }
        }

        return $this->render('UniControlPanelBundle:User:new.html.twig', array(
    ...
    private function createNewForm(User $user)
    {
        return $this->createForm(new UserType(), $user, array(
            'action' => $this->generateUrl('controlpanel_user_new'),
        ));
    }
    ...
    public function showAction(User $user)
    {
        ...
        return $this->render('UniControlPanelBundle:User:show.html.twig', array(
            'user' => $user,
    ...
    public function editAction(Request $request, User $user)
    {
        ...
        return $this->render('UniControlPanelBundle:User:edit.html.twig', array(
            'user' => $user,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    {
        return $this->createForm(new UserType(), $user, array(
            'action' => $this->generateUrl('controlpanel_user_edit', array('id' => $user->getId())),
        ));
    }
    ...
    private function createDeleteForm(User $user)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('controlpanel_user_delete', array('id' => $user->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
