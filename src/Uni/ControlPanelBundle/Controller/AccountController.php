...
class AccountController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($newForm->isSubmitted()) {
            if($newForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('controlpanel_account_index'));
            }
        }

        return $this->render('UniControlPanelBundle:Account:new.html.twig', array(
    ...
    private function createNewForm(Account $account)
    {
        return $this->createForm(new AccountType(), $account, array(
            'action' => $this->generateUrl('controlpanel_account_new'),
        ));
    }
    ...
    {
        return $this->createForm(new AccountType(), $account, array(
            'action' => $this->generateUrl('controlpanel_account_edit', array('id' => $account->getId())),
        ));
    }
    ...
    private function createDeleteForm(Account $account)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('controlpanel_account_delete', array('id' => $account->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
