...
use Uni\AgentBundle\Form\SellerType;
...
class SellerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Seller:index.html.twig', array(
            'sellers' => $sellers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Seller:new.html.twig', array(
    ...
    public function showAction(Seller $seller)
    {
        ...
        return $this->render('UniAgentBundle:Seller:show.html.twig', array(
            'seller' => $seller,
    ...
    public function editAction(Request $request, Seller $seller)
    {
        ...
        return $this->render('UniAgentBundle:Seller:edit.html.twig', array(
            'seller' => $seller,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
