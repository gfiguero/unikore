...
use Uni\AgentBundle\Form\ProviderType;
...
class ProviderController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Provider:index.html.twig', array(
            'providers' => $providers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Provider:new.html.twig', array(
    ...
    public function showAction(Provider $provider)
    {
        ...
        return $this->render('UniAgentBundle:Provider:show.html.twig', array(
            'provider' => $provider,
    ...
    public function editAction(Request $request, Provider $provider)
    {
        ...
        return $this->render('UniAgentBundle:Provider:edit.html.twig', array(
            'provider' => $provider,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
