...
use Uni\AgentBundle\Form\IssuerType;
...
class IssuerController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Issuer:index.html.twig', array(
            'issuers' => $issuers,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Issuer:new.html.twig', array(
    ...
    public function showAction(Issuer $issuer)
    {
        ...
        return $this->render('UniAgentBundle:Issuer:show.html.twig', array(
            'issuer' => $issuer,
    ...
    public function editAction(Request $request, Issuer $issuer)
    {
        ...
        return $this->render('UniAgentBundle:Issuer:edit.html.twig', array(
            'issuer' => $issuer,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
