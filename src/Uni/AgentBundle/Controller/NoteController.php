...
use Uni\AgentBundle\Form\NoteType;
...
class NoteController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Note:index.html.twig', array(
            'notes' => $notes,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Note:new.html.twig', array(
    ...
    public function showAction(Note $note)
    {
        ...
        return $this->render('UniAgentBundle:Note:show.html.twig', array(
            'note' => $note,
    ...
    public function editAction(Request $request, Note $note)
    {
        ...
        return $this->render('UniAgentBundle:Note:edit.html.twig', array(
            'note' => $note,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
