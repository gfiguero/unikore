...
class BudgetController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Budget:index.html.twig', array(
            'budgets' => $budgets,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Budget:new.html.twig', array(
    ...
    public function showAction(Budget $budget)
    {
        ...
        return $this->render('UniAgentBundle:Budget:show.html.twig', array(
            'budget' => $budget,
    ...
    public function exportAction(Budget $budget)
    {
        ...
        return $this->render('UniAgentBundle:Export:budget.html.twig', array(
            'budget' => $budget,
            'items' => $items,
            'seller' => $seller,
            'client' => $client,
    ...
    public function pdfAction(Budget $budget)
    {
        ...
        $html = $this->renderView('UniAgentBundle:Export:budget.html.twig', array(
            'budget' => $budget,
            'items' => $items,
            'seller' => $seller,
            'client' => $client,
    ...
    public function editAction(Request $request, Budget $budget)
    {
        ...
        return $this->render('UniAgentBundle:Budget:edit.html.twig', array(
            'budget' => $budget,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
