...
use Uni\AgentBundle\Form\AccountType;
...
class AccountController extends Controller
{
    public function editAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Account:edit.html.twig', array(
    ...
    public function showAction(Request $request)
    {
        $user = $this->getUser();
        $account = $user->getAccount();
        return $this->render('UniAgentBundle:Account:show.html.twig', array(
            'account' => $account,
        ));
    }
