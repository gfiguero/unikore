...
use Uni\AgentBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Client:index.html.twig', array(
            'clients' => $clients,
            'direction' => $direction,
            'sort' => $sort,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('UniAgentBundle:Client:new.html.twig', array(
    ...
    public function showAction(Client $client)
    {
        $user = $this->getUser();
        $account = $user->getAccount();
        if ($account != $client->getAccount()) return $this->redirect($this->generateUrl('agent_client_index'));

        $editForm = $this->createEditForm($client);
        $deleteForm = $this->createDeleteForm($client);

        return $this->render('UniAgentBundle:Client:show.html.twig', array(
            'client' => $client,
    ...
    public function editAction(Request $request, Client $client)
    {
        ...
        return $this->render('UniAgentBundle:Client:edit.html.twig', array(
            'client' => $client,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
